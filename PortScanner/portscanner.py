...
#A lightweight and Multithread network scanner that can be run with python
#Perfect for environments in which nmap is not accesible or permited but python is installed
import socket
import errno
import threading 
