...
def banner():
    ...
    print(r'''
        ...
        | $$      | $$| $$  | $$ /$$  \ $$| $$       /$$__  $$| $$  | $$| $$  | $$| $$_____/| $$      
        | $$      | $$|  $$$$$$$|  $$$$$$/|  $$$$$$$|  $$$$$$$| $$  | $$| $$  | $$|  $$$$$$$| $$      
        |__/      |__/ \____  $$ \______/  \_______/ \_______/|__/  |__/|__/  |__/ \_______/|__/      
                    /$$  | $$                                                                      
                    |  $$$$$$/                                                                      
                    \______/                                                                                                                                                    
    ''')      
...
def usage():
    print("FlyScanner, A Lightweight Scrapper")
    print("Usage: python3 flyscanner.py -t target_host -p port -v")
    ...
    print("Examples: ")
    print("python3 flyscanner.py -t 192.168.0.1 -p 5555 ")
    print("python3 flyscanner.py -t 192.168.100.1 -p 100-800 -o /file/to/path")
    print("python3 flyscanner.py -t 192.168.100.0/24 -p 1-1024 -c 350 ")
    exit(0)
